...
class _MapViewState extends State<MapView> {
  ...
  static final Marker _DICTSofficesMarker = const Marker(
  ...
  //   onTap: (){
  //     // Geofence.addGeolocation(const Geolocation(latitude:0.330588,longitude: 32.567492), GeolocationEvent.entry);
  //   }
  // );

  static final Marker _poolCourtMarker = const Marker(
    markerId: MarkerId('_place1'),
    infoWindow: const InfoWindow(
    ...
    icon: BitmapDescriptor.defaultMarker,
    position: const LatLng(0.334608, 32.569307),
  );
  static final Marker _swimmingPoolMarker = const Marker(
    markerId: MarkerId('_place1'),
    infoWindow: InfoWindow(
      title: 'Swimming pool',
  ...
  static final Marker _SenateBuildingMarker = const Marker(
